    ...
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                ...
                // To serve the Swagger UI at the app's root (http://localhost:<port>/), set:
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(c =>
            {
                c.SwaggerDoc("v1", new Info
                {
                    Title = "Library API",
                    Version = "v1",
                    Description = "A library API for nerds",
                    TermsOfService = "None",
                    Contact = new Contact
                    {
                        Name = "Wanno Drijfhout",
                        Email = "wanno@drijfhout.net",
                        Url = "http://wanno.drijfhout.net"
                    }
                });

                // Set the comments path for the Swagger JSON and UI.
                var xmlFile = Invariant($"{Assembly.GetExecutingAssembly().GetName().Name}.xml");
